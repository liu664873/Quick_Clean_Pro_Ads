...
fun SettingsScreen(
    ...
    val showAdPrivacyOptions = AdvertiseSdk.isPrivacyOptionsRequired

    fun openSettingsLink(
        url: String,
        trackClick: () -> Unit,
    ) {
    ...
    CleanXScaffoldPage(
        ...
        SettingsPanel {
            ...
            SettingsValueRow(
                ...
                value = null,
                onClick = {
                    openSettingsLink(AppConfig.TERMS_OF_SERVICE_URL) {
            ...
            SettingsValueRow(
                ...
                value = null,
                onClick = {
                    openSettingsLink(AppConfig.PRIVACY_POLICY_URL) {
            ...
            if (showAdPrivacyOptions) {
                SettingsValueRow(
                    ...
                    onClick = {
                        ...
                        if (activity == null) {
                            Log.w(TAG, "skip ad privacy options: activity unavailable")
                        } else {
                            runCatching {
                                AdvertiseSdk.showPrivacyOptions(activity)
                            }.onFailure { throwable ->
                                Log.w(TAG, "show ad privacy options failed", throwable)
                            }
                        }
                    },
                )
